...
### Changed
- **MCP Registry:** Migrated namespace from `io.github.gitscrum-core/mcp-server` to [`com.gitscrum/mcp`](https://registry.modelcontextprotocol.io) — professional domain-verified namespace
- DNS domain verification via Ed25519 TXT record on `gitscrum.com`
...
[1.0.2]: https://github.com/gitscrum-core/mcp-server/releases/tag/v1.0.2
